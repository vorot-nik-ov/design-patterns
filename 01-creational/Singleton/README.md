...
> *Примечание:* для продакшена на C++11 и выше рекомендуется использовать "Синглтон Мейерса" (объявление static AppSettings instance; внутри функции getInstance()), который гарантирует потокобезопасность на уровне компилятора.
